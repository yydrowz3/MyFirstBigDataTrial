...
public class UserServiceImpl implements UserService {
   ...
   @Override
    ...
    @Override
    public int relive(Integer id) {
        return userMapper.relive(id);
    }
    ...
    public int checkByEmail(String mail){
        if(mail == null || mail.equals("")) return 0;
        return userMapper.checkByEmail(mail);
    }
}
