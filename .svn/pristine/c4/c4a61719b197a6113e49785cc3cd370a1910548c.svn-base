...
export default defineComponent({
  ...
  setup() {
    ...
    const min = reactive([
      ...
      { name: "煤质分析技术", value: 2 },
      { name: "儿童康复", value: 2 },
      { name: "矿山安全技术与监察", value: 2 },
      { name: "固体矿床露天开采技术", value: 2 },
      { name: "森林消防", value: 2 },
      { name: "科技成果中介服务", value: 2 },
    ]);
    const max = reactive([
      { name: "会计学", value: 86568 },
      { name: "英语", value: 82534 },
      { name: "机械设计制造及其自动化", value: 78128,},
      { name: "计算机科学与技术", value: 66463,},
      { name: "土木工程", value: 66319 },
      { name: "汉语言文学", value: 64951 },
      { name: "电气工程及其自动化",value: 61506,},
      { name: "法学", value: 59041 },
      { name: "软件工程", value: 57507 },
      { name: "国际经济与贸易", value: 54814 },]);
    ...
    onBeforeMount(() => {
      ...
      selectUPMByRanking()
        .then((res) => {
          res.data.data.forEach((element) => {
            // min.push({ name: element.name, value: element.plan })
          });
          countView = true;
          console.log("r");
      ...
      selectPMByRanking()
        .then((res) => {
          res.data.data.forEach((element) => {
            // max.push({ name: element.name, value: element.plan })
          });
          countView = true;
          console.log("l");
          console.log(res.data.data);
