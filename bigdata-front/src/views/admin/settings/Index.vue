        ...
        <div class="select-box">
          <el-form :inline="true" :model="selectData" class="demo-form-inline">
            ...
            <el-form-item label="省份">
              <el-select v-model="selectData.province" placeholder="请选择省份">
                <el-option
      ...
      <el-table border :data="infoTotalList" style="width: 100%" stripe>
        ...
        <el-table-column fixed="right" label="操作" width="100">
          <template #default="scope">
            <el-button round type="primary" @click="editInfo(scope.row)"
              >编辑</el-button
            >
...
export default defineComponent({
  setup() {
    ...
    const updateList = () => {
      ...
      getSchoolInfo({
        enrollmentInfo: {
          ...
          province: data.queryData.province,
        },
        ...
        .then((res) => {
          ...
          data.selectData.province = data.queryData.province;
        })
        .catch((err) => {});
    };
    onBeforeMount(() => {
    ...
    const onQuery = () => {
      data.queryData.schoolName = data.selectData.schoolName.trim();
      data.queryData.profess = data.selectData.profess.trim();
      data.queryData.province = data.selectData.province;
      data.currentPage = 1;
      updateList();
    };
